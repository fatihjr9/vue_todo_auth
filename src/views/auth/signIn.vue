<template>
    <div>
        <auth-layout>
            <!-- Header -->
            <div slot="header" class="flex flex-row items-center gap-x-2 mt-16 justify-center">
            ...
            <!-- Content -->
            <form @submit.prevent="handleSignIn" class="max-w-sm mx-auto mt-10 ring-1 bg-white shadow-sm ring-gray-100 rounded-lg">
                <h5 class="text-xl text-center font-medium py-2 border-b">Login</h5>
                <div class="p-4">
                    <div class="mb-4">
